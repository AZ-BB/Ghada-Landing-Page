...
export function HeroSectionAr() {
  const stats = [
    { icon: Star, label: '+20 سنة', sublabel: 'خبرة' },
    { icon: Award, label: 'دولية', sublabel: 'شهادات' },
    { icon: Users, label: '5,000+', sublabel: 'عملاء' },
    { icon: Calendar, label: 'قبل أسبوع', sublabel: 'المواعيد' },
  ]
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0">
              علاجات شخصية مبنية على الأدلة بنتائج طبيعية وراقية. موثوقة من قبل الآلاف في أبوظبي لأكثر من <span className="text-gold font-semibold">20 سنة</span>.
            </p>

            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
              <a
                href="tel:+97125555097"
                aria-label="اتصل لحجز استشارة"
              ...
              <a
                href="#services"
                aria-label="عرض الخدمات المتاحة"
            ...
            <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-4">
              {stats.map((stat, index) => (
                <div key={index} className="flex items-center justify-center sm:justify-end gap-3 rounded-xl border border-white/5 bg-white/[0.04] px-4 py-3 overflow-hidden">
          ...
          >
            <div className="relative mx-auto max-w-md lg:max-w-none p-16 pb-4 rounded-2xl border-2 border-gold bg-gold/80 backdrop-blur-sm shadow-gold">
              ...
              <div
                ...
                aria-label="بطاقة تعريف مع التقييم"
              >
